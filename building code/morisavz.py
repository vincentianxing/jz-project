...
# Game over
    ...
    if dist >= 0 :
        direction = int(random.choice((0, 2, 3)))
        dvelocity = 0
        changeMode = 1
    ...
    if timer < 100:
        ...
        if timer == 0:
            location = circleX
        timer += 1
        cv2.line(frame, (location, 0),
                    (location, 600), (255, 255, 255), 5)

    # shoot the danmaku and check if it hits the player
    if timer >= 100:
        timer += 1
        cv2.rectangle(frame, (location - (timer - 98) * 5, 0),
                        (location + (timer - 98) * 5, 600), (255, 255, 255), -1)
        if timer >= 110:
            cv2.rectangle(frame, (location - (timer - 108) * 5, 0),
                            (location + (timer - 108) * 5, 600), (0, 165, 255), -1)
        if timer >= 120:
            cv2.rectangle(frame, (location - (timer - 118) * 5, 0),
                            (location + (timer - 118) * 5, 600), (0, 255, 0), -1)
        if timer >= 130:
            cv2.rectangle(frame, (location - (timer - 128) * 5, 0),
                            (location + (timer - 128) * 5, 600), (255, 0, 0), -1)
        if timer >= 140:
            cv2.rectangle(frame, (location - (timer - 138) * 5, 0),
                            (location + (timer - 138) * 5, 600), (0, 255, 255), -1)
        #check if it hits the player
        if circleX >= (location - (timer - 98) * 5) and circleX <= (location + (timer - 98) * 5):
            count -= 1
            cv2.line(frame, (circleX + 25, circleY),
                        (circleX + 35, circleY), (0, 0, 255), 4)
            cv2.line(frame, (circleX + 40, circleY - 10),
                        (circleX + 40, circleY + 10), (0, 0, 255), 4)
    ...
    if xTimer >= 400 and xTimer < 1000:
        ...
        cv2.line(frame, (bossX - 10, bossY - 25),
                    (bossX - 30, bossY - 45), (0, 0, 0), 8)
        cv2.line(frame, (bossX + 10, bossY - 25),
                    (bossX + 30, bossY - 45), (0, 0, 0), 8)
        cv2.circle(frame, (bossX - 15, bossY - 10), 4, (0, 0, 0), -1)
        cv2.circle(frame, (bossX + 15, bossY - 10), 4, (0, 0, 0), -1)
        cv2.line(frame, (bossX - 25, bossY + 20),
                    (bossX + 25, bossY + 20), (0, 0, 0), 8)
        #Left
        ...
        if xTimer >= 480:
            ...
            if (xTimer % 60) == 0:
                leftLocal = circleY
            if (xTimer % 60) <= 20:
                cv2.line(frame, (0, leftLocal),
                            (1000, leftLocal), (255, 255, 255), 4)
            if (xTimer % 60) > 20 and (xTimer % 60) <= 35:
                cv2.line(frame, (0, leftLocal),
                            (1000, leftLocal), (97, 128, 234), 8)
            ...
            if (xTimer % 160) == 0:
                middleX = circleX
                middleY = circleY
                dBossX = int(10 * (middleX - bossX) /
                                (abs(middleX - bossX) + abs(middleY - bossY)))
                dBossY = int(10 * (middleY - bossY) /
                                (abs(middleX - bossX) + abs(middleY - bossY)))
            if (xTimer % 160) < 80:
                bossX += dBossX
                bossY += dBossY
            ...
            if (xTimer % 80) == 0:
                dRight = 0
            # south bullet
            cv2.circle(frame, (750, 120 + dRight * 8),
                        20, (0, 0, 0), -1)
            cv2.circle(frame, (750, 120 + dRight * 8),
                        15, (255, 255, 255), -1)
            if (circleX - 750) * (circleX - 750) + (circleY - 120 - dRight * 8) * (circleY - 120 - dRight * 8) < 625:
                ...
                cv2.line(frame, (circleX + 40, circleY - 10),
                            (circleX + 40, circleY + 10), (0, 0, 255), 4)
            # southeast bullet
            cv2.circle(frame, (750 + dRight * 6, 120 +
                                dRight * 6), 20, (0, 0, 0), -1)
            cv2.circle(frame, (750 + dRight * 6, 120 +
                                dRight * 6), 15, (255, 255, 255), -1)
            ...
            if (circleX - 750 + dRight * 6) * (circleX - 750 + dRight * 6) + (circleY - 120 - dRight * 6) * (circleY - 120 - dRight * 6) < 625:
                ...
                cv2.line(frame, (circleX + 40, circleY - 10),
                            (circleX + 40, circleY + 10), (0, 0, 255), 4)
            # west bullet
            cv2.circle(frame, (750 - dRight * 9, 120),
                        20, (0, 0, 0), -1)
            cv2.circle(frame, (750 - dRight * 9, 120),
                        15, (255, 255, 255), -1)
    ...
    cv2.rectangle(frame, (circleX - 5, circleY - 35),
                    (circleX + 5, circleY), (0, 0, 255), 10)
    cv2.rectangle(frame, (circleX - 7, circleY - 50),
                    (circleX - 5, circleY - 35), (0, 255, 255), 2)
    cv2.rectangle(frame, (circleX - 1, circleY - 50),
                    (circleX + 1, circleY - 35), (0, 255, 255), 2)
    cv2.rectangle(frame, (circleX + 5, circleY - 50),
                    (circleX + 7, circleY - 35), (0, 255, 255), 2)
    ...
    cv2.line(frame, (circleX - 8, circleY - 15),
                (circleX - 38, circleY - 35), (0, 125, 125), 3)
    cv2.line(frame, (circleX + 8, circleY - 15),
                (circleX + 38, circleY - 35), (0, 125, 125), 3)
    ...
    if (changeMode == 1):
        # change it back
        changeMode = 0
        cv2.circle(frame, (circleX, circleY), 5, (random.randrange(
            1, 255), random.randrange(1, 255), random.randrange(1, 255)), 10)
        cv2.rectangle(frame, (circleX - 5, circleY - 35), (circleX + 5, circleY),
                        (random.randrange(1, 255), 0, random.randrange(1, 255)), 10)
        cv2.rectangle(frame, (circleX - 7, circleY - 50), (circleX - 5, circleY - 35),
                        (random.randrange(1, 255), random.randrange(1, 255), random.randrange(1, 255)), 2)
        cv2.rectangle(frame, (circleX - 1, circleY - 50), (circleX + 1, circleY - 35),
                        (random.randrange(1, 255), random.randrange(1, 255), random.randrange(1, 255)), 2)
        cv2.rectangle(frame, (circleX + 5, circleY - 50), (circleX + 7, circleY - 35),
                        (random.randrange(1, 255), random.randrange(1, 255), random.randrange(1, 255)), 2)
        cv2.circle(frame, (circleX-5, circleY - 25), 2, (random.randrange(1,
                                                                            255), random.randrange(1, 255), random.randrange(1, 255)), 4)
        cv2.circle(frame, (circleX+5, circleY - 25), 2, (random.randrange(1,
                                                                            255), random.randrange(1, 255), random.randrange(1, 255)), 4)
        cv2.circle(frame, (circleX, circleY - 15), 3, (random.randrange(1,
                                                                        255), random.randrange(1, 255), random.randrange(1, 255)), 6)
        cv2.circle(frame, (circleX, circleY - 17), 3, (0, 0, 255), 6)
        cv2.line(frame, (circleX - 8, circleY - 15), (circleX - random.randrange(25, 40), circleY - random.randrange(
            1, 40)), (random.randrange(1, 255), random.randrange(1, 255), random.randrange(1, 255)), 2)
        cv2.line(frame, (circleX + 8, circleY - 15), (circleX + random.randrange(25, 40), circleY - random.randrange(
            1, 40)), (random.randrange(1, 255), random.randrange(1, 255), random.randrange(1, 255)), 2)
